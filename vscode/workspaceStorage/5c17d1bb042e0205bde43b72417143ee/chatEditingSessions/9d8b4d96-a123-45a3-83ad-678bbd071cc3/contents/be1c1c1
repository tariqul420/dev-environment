...
type Props = {
  ...
  className?: string;
  viewClass?: string;
  selectableImages?: string[]; // Array of image URLs that users can select from
};
        ...
        <FormItem className={className}>
          ...
          <FormControl>
            <div className={cn("flex flex-col gap-2", viewClass)}>
              ...
              >
                ...
                {files.length > 0 ? (
                  <div className="flex w-full flex-col gap-3">
                      ...
                      <div className="flex gap-2">
                        {selectableImages.length > 0 && (
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => setShowSelectableImages(!showSelectableImages)}
                    ...
                    {showSelectableImages && selectableImages.length > 0 && (
                      <div className="border-t pt-3">
                        <h4 className="text-sm font-medium mb-2">Select from available images:</h4>
                        <div className="grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-4 max-h-60 overflow-y-auto">
                          {selectableImages.map((imageUrl) => {
                            const isSelected = getList().includes(imageUrl);
                            return (
                              <button
                                key={imageUrl}
                                type="button"
                                className={cn(
                                  "relative aspect-square rounded-md border-2 transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2",
                                  isSelected 
              ...
              {files.length === 0 && showSelectableImages && selectableImages.length > 0 && (
                <div className="border border-dashed rounded-xl p-4 mt-2">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-sm font-medium">Select from available images:</h4>
                    <Button
                      variant="ghost"
                      size="sm"
