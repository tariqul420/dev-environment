...
import { format } from "date-fns"        <div className="relative flex flex-col items-center gap-2 px-6 pb-8 pt-8 text-center">
          <div className="bg-background shadow-lg mb-2 flex h-20 w-20 items-center justify-center rounded-full">
            {getStatusIcon(status, "h-10 w-10")}
          </div>
          <h1 className="text-3xl font-bold">
            {status === "PENDING" && "অর্ডারটি পেন্ডিং রয়েছে"}
            {status === "HOLD" && "অর্ডারটি হোল্ডে রয়েছে"}
            {status === "CONFIRMED" && "অর্ডার নিশ্চিত করা হয়েছে"}
            {status === "PROCESSING" && "অর্ডার প্রসেসিং এ রয়েছে"}
            {status === "SHIPPED" && "অর্ডার শিপ করা হয়েছে"}
            {status === "DELIVERED" && "অর্ডার ডেলিভার হয়েছে"}
            {status === "CANCELLED" && "অর্ডার বাতিল করা হয়েছে"}
          </h1>
          <p className="text-muted-foreground max-w-2xl">
            {status === "PENDING" && "আপনার অর্ডারটি পেন্ডিং এ রয়েছে। খুব শিগগিরই নিশ্চিত করা হবে, ইনশা-আল্লাহ।"}
            {status === "HOLD" && "আপনার অর্ডারটি সাময়িকভাবে হোল্ডে রয়েছে। আরও তথ্যের জন্য আমাদের সাথে যোগাযোগ করুন।"}
            {status === "CONFIRMED" && "আপনার অর্ডারটি সফলভাবে নিশ্চিত করা হয়েছে। খুব শিগগিরই প্রসেসিং এর জন্য পাঠানো হবে, ইনশা-আল্লাহ।"}
            {status === "PROCESSING" && "আপনার অর্ডারটি বর্তমানে প্রসেসিং এ রয়েছে। খুব শিগগিরই শিপমেন্টের জন্য প্রস্তুত হবে, ইনশা-আল্লাহ।"}
            {status === "SHIPPED" && "আপনার অর্ডারটি শিপ করা হয়েছে। খুব শিগগিরই আপনার কাছে পৌঁছে যাবে, ইনশা-আল্লাহ।"}
            {status === "DELIVERED" && "আপনার অর্ডারটি সফলভাবে ডেলিভার করা হয়েছে। আমাদের সেবা নেওয়ার জন্য ধন্যবাদ।"}
            {status === "CANCELLED" && "আপনার অর্ডারটি বাতিল করা হয়েছে। কোনো প্রশ্ন থাকলে আমাদের সাথে যোগাযোগ করুন।"}
          </p>{
  CheckCircle2,
  CreditCard,
  HandHelping,
    ...
    <main className="py-10">
      ...
      <div className="bg-primary/5 relative overflow-hidden rounded-lg border">
        ...
        <div className="relative flex flex-col items-center gap-2 px-6 pb-8 pt-8 text-center">
          ...
          <h1 className="text-3xl font-bold">অর্ডার নিশ্চিত করা হয়েছে</h1>
          <p className="text-muted-foreground max-w-2xl">
            আপনার অর্ডারটি সফলভাবে গ্রহণ করা হয়েছে। খুব শিগগিরই ডেলিভারির জন্য প্রসেস করা
            হবে, ইনশা-আল্লাহ।
          </p>
