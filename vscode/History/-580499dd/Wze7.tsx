...
export default function PasswordStrengthPage() {
  ...
  const CrackTimes = [
    { label: 'Online (10/sec)', value: '' },
    { label: 'Online Fast (100/sec)', value: '' },
    { label: 'Offline (slow hash ~100k/sec)', value: '' },
    { label: 'Offline (fast hash ~10B/sec)', value: '' },
    { label: 'Nation-state (1T/sec)', value: '' },
  ];
