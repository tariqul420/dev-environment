...
import { AlignLeft, BarChart2, Clock4, Copy, Download, FileText, Info, Mic, Type as TypeIcon, UploadCloud } from 'lucide-react';
        ...
        <GlassCard className="p-5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <DownloadTextButton filename="original.txt" getText={() => displayText} label="Export" size="sm" disabled={!displayText} />
            </div>
          </div>
