...
export default function WordCounterPage() {
  ...
  return (
    <>
      ...
      <ToolPageHeader icon={TypeIcon} title="Word Counter" description="Count words, characters, sentences, paragraphs, and estimate read/speak time. Clean, transform, and export your text." />
