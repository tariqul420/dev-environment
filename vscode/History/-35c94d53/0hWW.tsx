...
export const metadata: Metadata = {
  ...
  description:
    "Shop Natural Sefa for trusted natural remedies: Methi Mix, Kalojira Tel, Diabetes Cha, and more. 100% natural, delivered across Bangladesh.",
  keywords:
    "Natural Sefa, natural health, herbal remedies, Methi Mix, Kalojira Tel, Diabetes Cha, Allergy Binash, Joytuner Tel, Arjun Heart Care, Bangladesh, organic health, wellness",
