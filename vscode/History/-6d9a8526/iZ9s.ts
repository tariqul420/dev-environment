...
export const updateUserRole = async ({
  ...
  // Fetch target user with lean typing
  ...
  // Decide the next role (toggle if not given)
  const nextRole: AppRole =
    newRole ?? (user.role === "admin" ? "customer" : "admin");

  // Update in Mongo and return lean typed doc
  ...
  // Sync to Clerk publicMetadata (clerkClient is an object, not a function)
