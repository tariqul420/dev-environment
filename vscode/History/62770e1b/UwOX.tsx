  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-10">
      ...
      <MotionGlassCard className="p-4">
        {/* header strip */}
        {/* <GlassCard className="mb-3 flex items-center justify-between rounded-xl p-3 text-xs text-muted-foreground">{lastAns && <div className="font-medium">ANS: {lastAns}</div>}</GlassCard> */}
