    ...
    <div className="py-10 space-y-8">
      ...
      <BreadcrumbContainer
        items={[
          ...
          { label: 'Calculators', href: '/tools/calc' },
          { label: 'BMI Calculator', href: '/tools/calc/bmi' },
        ]}
      />

      {/* Top Header */}
      <SectionHeader title="BMI Calculator" desc="Calculate Body Mass Index with metric or imperial inputs and see your healthy weight range." />
      ...
      <MotionGlassCard className="space-y-4">
        ...
        <GlassCard className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-6 py-5">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Enter height & weight, choose units, then calculate.</p>
          </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <GlassCard className="p-4">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="mt-1">{submitted && parsed ? categoryBadge(parsed.category) : <Badge variant="outline">—</Badge>}</div>
                </div>
              </GlassCard>
              <GlassCard className="p-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Underweight &lt; 18.5 • Healthy 18.5–24.9 • Overweight 25–29.9 • Obese ≥ 30. Healthy range depends on height; always consider body composition and consult professionals when
                      needed.
                    </p>
                  </div>
                </div>
              ...
              <GlassCard className="p-4">
                <div className="space-y-2">
                  ...
                  <Textarea placeholder="Add any notes (e.g., morning weight, after workout, etc.)" value={note} onChange={(e) => setNote(e.target.value)} className="min-h-[70px]" />
                  {submitted && (!parsed || note) && <p className="text-xs text-muted-foreground">{parsed ? 'Saved locally in this session.' : 'Enter valid numbers and hit Calculate.'}</p>}
                </div>
              </GlassCard>
            </div>
          </CardContent>
