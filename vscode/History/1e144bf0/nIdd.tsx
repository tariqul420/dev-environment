          ...
          <div className="flex flex-wrap items-center gap-2">
            <Tooltip>
              <TooltipTrigger asChild>
                <Button asChild size="sm" variant="outline">
                  <Link onClick={handelURL} href="/admin/analytics">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuItem asChild>
                  <Link onClick={handelURL} href="/admin/settings">
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex w-full items-center gap-2 md:w-80 overflow-hidden rounded-md dark:bg-transparent">
              ...
              <CardContent className="space-y-3">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Button asChild variant="outline">
                    <Link onClick={handelURL} href="/admin/messages">
              ...
              <CardContent className="space-y-3">
                {QUICK_TASKS.map((t) => (
                  <label key={t.id} className="flex cursor-pointer items-center gap-3 rounded-xl p-2 hover:bg-muted/40">
                    <Checkbox defaultChecked={['t1', 't3', 't4'].includes(t.id)} id={t.id} />
