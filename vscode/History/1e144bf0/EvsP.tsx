...
// ⬇️ shadcn/ui components — make sure these are installed in your project
// If any are missing, add them with: npx shadcn@latest add card button badge tabs table avatar progress dropdown-menu input separator checkbox switch scroll-area tooltip sheet
...
// ————————————————————————————————————————————————————————————————————————
// Sample dashboard data (replace with real queries/actions)
// ————————————————————————————————————————————————————————————————————————
const STAT_CARDS = [
...
function MessagesTable({ messages, compact = false }: { messages: typeof RECENT_MESSAGES; compact?: boolean }) {
  return (
    <Table>
      <TableHeader>
        <TableRow>
...
// Tiny sparkline using pure CSS — avoids adding a chart library just for a small visual
