  ...
  return (
    <MotionGlassCard>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <LinkBtn link={link.targetUrl as string} />
      </div>
...
export function LinkBtn(link: string) {
  "use client";

  return (
    <div className="flex flex-wrap gap-2">
      <LinkButton href={link} label="Open target" target="_blank" />
      <LinkButton icon={LinkIcon} href="/tools/url/shortener" label="Make another" />
    </div>
  );
}
