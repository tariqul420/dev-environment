      ...
      <main className="flex-grow">
        ...
        <section className="max-w-4xl mx-auto text-center py-20 px-6">
          ...
          <figure className="flex flex-col items-center space-y-6">
            {/* Avatar Image */}
            <Image src={testimonials[testimonialIndex].image} alt={`${testimonials[testimonialIndex].author} photo`} className="w-24 h-24 rounded-full object-cover shadow-md" loading="lazy" />

            {/* Quote */}
            <blockquote className="italic text-lg text-muted-foreground max-w-xl">“{testimonials[testimonialIndex].quote}”</blockquote>

            {/* Author */}
            <figcaption className="mt-2 font-semibold text-foreground">{testimonials[testimonialIndex].author}</figcaption>
          </figure>
