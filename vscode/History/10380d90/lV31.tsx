      ...
      <main className="flex-grow">
        ...
        <section className="max-w-4xl mx-auto text-center py-20 px-6">
          ...
          <figure className="flex flex-col items-center space-y-6">
            {/* Avatar Image */}
            <img src={testimonials[testimonialIndex].image} alt={`${testimonials[testimonialIndex].author} photo`} className="w-24 h-24 rounded-full object-cover shadow-md" loading="lazy" />
