  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      <main className="flex-grow">
        {/* Hero */}
        <section className="bg-primary text-primary-foreground py-28 px-6 mt-20">
        ...
        {/* Newsletter Signup */}
        <section className="bg-primary text-primary-foreground py-20 px-6 text-center rounded-t-3xl">
          <h2 className="text-3xl font-semibold mb-4">Stay Updated</h2>
          <p className="max-w-xl mx-auto mb-8 opacity-90">Get the latest Meetora news and updates right in your inbox.</p>
          <form
            onSubmit={(e) => {
              e.preventDefault();
            ...
            <input
              ...
              className="flex-grow rounded-md border border-input px-4 py-3 bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
            />
        ...
        {/* Call to Action */}
        <section className="py-20 px-6 bg-muted/70 text-center rounded-b-3xl">
          <h2 className="text-4xl font-bold mb-4">Ready to Hire Smarter?</h2>
          <p className="text-muted-foreground max-w-xl mx-auto mb-8">Join thousands of teams using Meetora for structured, remote-first interviews.</p>
