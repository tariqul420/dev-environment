...
const AddminPage = () => {
  ...
  const devMenuItems = [
    ...
    { name: "Code Repository", icon: GitBranch, active: false, badge: "3" },
    { name: "API Management", icon: Code2, active: false, badge: null },
    { name: "Database Admin", icon: Database, active: false, badge: "2" },
    { name: "Server Monitor", icon: Server, active: false, badge: null },
    { name: "Bug Tracker", icon: Bug, active: false, badge: "12" },
    { name: "Logs & Analytics", icon: Activity, active: false, badge: null },
    { name: "Terminal", icon: Terminal, active: false, badge: null },
  ...
  return (
    <div className="bg-background flex min-h-screen">
      ...
      <div className="flex flex-1 flex-col">
        ...
        {/* Dashboard Content */}
        <main className="bg-card flex-1 p-6">
          {/* Welcome Section */}
          <div className="mb-8">
          ...
          <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {devStats.map((stat, index) => (
              <Card
                key={index}
                className="cursor-pointer border border-gray-700 bg-gray-800 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-gray-600 hover:shadow-2xl"
