...
const AdminPage = () => {
  ...
  return (
    <div className="bg-card/50 flex-1 rounded-md p-6">
      {/* Welcome Section */}
        ...
        {devStats.map((stat, index) => {
          const isUp =
            (typeof stat.change === "string" &&
              stat.change.trim().startsWith("+")) ||
            (typeof stat.change === "number" && stat.change > 0);

          return (
            <Card
              key={index}
              className="group border-border bg-card hover:ring-primary/20 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md hover:ring-1"
            ...
            >
              <CardHeader className="pb-2">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="mt-2 inline-flex flex-wrap items-center gap-1.5 text-sm">
                      <span
                      ...
                      <span
                        className={isUp ? "text-emerald-600" : "text-rose-500"}
                      >
                  ...
                  {/* Icon badge */}
                  <div
                    className={`bg-primary/10 text-primary inline-block rounded-xl p-3 transition-transform duration-300 group-hover:scale-105`}
                  >
              ...
              {/* Optional tiny progress / sparkline area */}
              {stat.progress != null && (
