                ...
                <div className="relative rounded-xl bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 p-6 text-white">
                  <div className="relative z-10">
                    ...
                    <p className="text-blue-100">
                      System running smoothly • All services operational • Ready
                      for deployment
                    </p>
                  </div>

                  {/* subtle highlight blob */}
                  <div className="absolute top-0 right-0 h-32 w-32 translate-x-16 -translate-y-16 transform rounded-full bg-white/10" />
                </div>
              </CardContent>
            </Card>
          </div>
