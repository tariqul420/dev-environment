...
const AdminPage = () => {
  ...
  return (
    <div className="bg-background flex min-h-screen rounded-md">
      {/* Main Content */}
      <div className="flex flex-1 flex-col rounded-md">
        {/* Dashboard Content */}
        <main className="bg-card/50 flex-1 rounded-md p-6">
          {/* Welcome Section */}
          <div className="mb-8">
              ...
              <Card key={index} style={{ animationDelay: `${index * 0.1}s` }}>
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="mb-2 text-sm text-gray-400">{stat.title}</p>
