  ...
  return (
    <MotionGlassCard className="p-4 md:p-6 lg:p-8">
      <ToolPageHeader
        ...
        subtitle="Convert between binary, octal, decimal, hex — plus any base 2–36. Fractions supported."
        icon={<Calculator className="h-6 w-6" />}
        actions={
          <div className="flex flex-wrap gap-2">
            <ActionButton icon={RefreshCw} onClick={() => setRaw((v) => v.trim())}>
              Normalize
            </ActionButton>
            ...
            />
            <ResetButton icon={RotateCcw} onClick={resetAll}>
              Reset
            </ResetButton>
          </div>
        }
