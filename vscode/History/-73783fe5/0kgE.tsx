...
/**
 * Sponsor Page for Tools Hub
 * - Clean, glassy UI with subtle gradients
 * - Sponsor tiers, benefits matrix, logo wall, FAQ, contact form
 * - Production-ready, uses shadcn/ui + Tailwind + Framer Motion
 */
...
const tiers = [
  ...
  },
  {
    ...
    icon: Rocket,
    highlight: false,
    perks: ['Everything in Gold', 'Co-branded tutorial/tool', 'Quarterly campaign planning call', 'Logo in app footer (opt-in)'],
  },
] as const;
...
const faqs = [
  {
    ...
    a: 'Your logo appears on this page and (for higher tiers) in a rotating carousel on the homepage and select tool pages.',
  },
  {
    q: 'Can I sponsor a specific tool?',
    a: 'Yes. We support tool-level sponsorship for targeted exposure. Mention the tool in your message.',
  },
  {
    q: 'Do you accept annual billing?',
    a: 'Absolutely—annual plans come with a discount and an invoice.',
  },
  {
    q: 'What creative assets do you need?',
    a: 'A horizontal SVG/PNG logo, a one-liner, and an optional UTM-tracked link.',
  },
];
