...
export const latestProject = [
  ...
  {
    name: 'Edu Genius',
    path: 'https://edugenius.tariqul.dev',
  },
  {
...
export default function Footer() {
  return (
    <footer className="py-8 px-4">
      <AnimationContainer delay={0.6} className="w-full md:w-11/12 py-4 px-6 border-b-2 border-border bg-card rounded-md max-w-7xl mx-auto">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3">
          <div className="flex flex-col">
            ...
            <div className="mt-4 flex space-x-4">
              ...
              <Link target="_blank" href="https://www.facebook.com/tariqul2984" className="text-red transition-all duration-300 hover:-translate-y-1" aria-label="Visit our youtube page">
                <Facebook />
              </Link>
