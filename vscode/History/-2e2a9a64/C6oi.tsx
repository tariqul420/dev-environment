      ...
      <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {categories.map((c) => (
          <Link key={c.key} href={`#cat-${c.key}`} className="group focus:outline-none">
            <GlassCard className="relative h-full overflow-hidden rounded-2xl border bg-card/60 backdrop-blur supports-[backdrop-filter]:bg-card/40 transition-all hover:border-primary/50 hover:shadow-[0_8px_30px_rgba(2,132,199,0.08)] focus-within:ring-2 focus-within:ring-primary/40">
              <div
                aria-hidden
