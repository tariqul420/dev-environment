...
export default async function Checkout({
  ...
  const { slug, quantity = 1 } = await searchParams;
  ...
  return (
    <div className="py-12">
      <InitialCheckoutTracking id={product._id} totalPrice={Number(total)} price={Number(product.salePrice)} slug={slug} qty={Number(quantity)}/>
