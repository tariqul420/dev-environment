...
import { DownloadTextButton, ImportFileButton } from '@/components/shared/action-buttons';
    ...
    <>
      ...
      <GlassCard className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Remove extra spaces, emojis, HTML, etc.</p>
        </div>
      ...
      <ToolPageHeader
        ...
        actions={
          <>
            ...
            />
            <DownloadTextButton variant="outline" filename="text.txt" getText={() => output || input || ''} label="Export" disabled={!input || !output} />
