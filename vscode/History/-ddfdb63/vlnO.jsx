...
const formSchema = z.object({
  ...
  // File URL fields
  nid: z.string().url().optional().default(""),
  certificate: z.string().url().optional().default(""),
  drivingLicence: z.string().url().optional().default(""),
  utilityBill: z.string().url().optional().default(""),
  medicalReport: z.string().url().optional().default(""),
  doopTestReport: z.string().url().optional().default(""),
  visa: z.string().url().optional().default(""),
  passport: z.string().url().optional().default(""),
  ticket: z.string().url().optional().default(""),
});
