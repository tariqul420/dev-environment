      ...
      <div className="my-12 max-w-4xl mx-auto">
        <Card className="dark:bg-dark-lite dark:text-white">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-lg mb-6">Sorry, we couldn&apos;t find the blog you&apos;re looking for. It might have been removed or the URL might be incorrect.</p>
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto py-10 px-4">
        ...
        <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-6">
          ...
          <LikeButtonClient slug={slug} initialLikes={blog.likes ?? 0} />
        </div>
