...
const Icons = {
  email: (props: IconProps) => <MailIcon size={24} {...props} />,
...
const DATA = {
  contact: {
    social: {
      GitHub: {
        name: 'GitHub',
        url: 'https://github.com/tariqul420',
        icon: Icons.github,
      },
      LinkedIn: {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/tariqul-dev',
        icon: Icons.linkedin,
      },
      X: {
        name: 'X',
        url: 'https://x.com/tariqul_420',
        icon: Icons.x,
      },
      Gmail: {
        name: 'Send Email',
        url: 'mailto:contact@tariqul.dev',
        icon: Icons.email,
      },
      Facebook: {
        name: 'Facebook',
        url: 'https://www.facebook.com/tariqul2984',
        icon: Icons.facebook,
      },
      Whatsapp: {
        name: 'Whatsapp',
        url: 'https://wa.me/8801743892058',
        icon: Icons.whatsapp,
      },
    },
  },
            ...
            <DockIcon key={name}>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Link target="_blank" href={social.url} aria-label={social.name} className={cn(buttonVariants({ variant: 'ghost', size: 'icon' }), 'size-12 rounded-full')}>
