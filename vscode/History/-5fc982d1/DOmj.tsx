      ...
      <GlassCard className="shadow-sm">
        ...
        <CardContent className="grid gap-6">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-6">
            <InputField id="cd-label" label="Countdown Label" placeholder="e.g., Tea break" value={cdLabel} onChange={(e) => setCdLabel(e.target.value)} />
            <InputField id="cd-min" label="Minutes" type="number" min={1} value={cdMin} onChange={(e) => setCdMin(e.target.value === '' ? '' : Number(e.target.value))} />
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-8">
            <InputField label="Work (min)" id="po-work" type="number" min={1} value={poWork} onChange={(e) => setPoWork(e.target.value === '' ? '' : Number(e.target.value))} />
            <InputField label="Break (min)" id="po-break" type="number" min={1} value={poBreak} onChange={(e) => setPoBreak(e.target.value === '' ? '' : Number(e.target.value))} />
            <InputField label="Cycles" id="po-cycles" type="number" min={1} value={poCycles} onChange={(e) => setPoCycles(e.target.value === '' ? '' : Number(e.target.value))} />
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-8">
            <div className="sm:col-span-2 space-y-2">
              ...
              <Input id="ev-label" value={evLabel} onChange={(e) => setEvLabel(e.target.value)} />
            </div>
            <InputField label="Event Label" id="ev-label" value={evLabel} onChange={(e) => setEvLabel(e.target.value)} />
