...
import { Cake, Calendar, Check, Clock, Copy, HeartPulse, Info } from 'lucide-react';
    ...
    <>
      ...
      <ToolPageHeader
        ...
        actions={
          <>
            ...
            <CopyButton variant="default" getText={() => link || ''} label="Copy link" disabled={!link} />
          </>
        }
      />
      ...
      <GlassCard className="shadow-sm">
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          <InputField className="w-full" label="Date of Birth" id="dob-date" type="date" value={dobDate} onChange={(e) => setDobDate(clampDateString(e.target.value))} />
