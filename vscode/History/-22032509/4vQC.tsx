...
import { Cake, Calendar, Check, Copy, HeartPulse, Info } from 'lucide-react';
          ...
          {birth && results && (
            <>
              ...
              <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <Stat label="Next Birthday" value={`${results.until.days} days`} hint={`${results.until.weekday}, ${results.until.exact}`} icon={<Cake className="h-4 w-4" />} />
              </div>
