...
export default function DiffCheckerClient() {
  ...
  const chunks = React.useMemo(() => compute(), [compute, auto]);
      ...
      <ToolPageHeader
        ...
        actions={
          <>
            ...
            <CopyButton getText={unified} label="Copy Diff" />
            <ExportTextButton filename="diff.patch" getText={() => unified} label="Export PATCH" />
