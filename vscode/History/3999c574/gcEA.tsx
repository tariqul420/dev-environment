...
export default function SearchBar({
  ...
  // Keep local state in sync with URL (e.g., back/forward navigation)
  React.useEffect(() => {
    ...
    <div className={cn("relative", className)}>
      ...
      {showClear && value ? (
        <button
          type="button"
          onClick={() => setValue("")}
          className="text-muted-foreground hover:bg-accent absolute inset-y-0 right-2 my-auto h-6 w-6 rounded-md focus:outline-none"
