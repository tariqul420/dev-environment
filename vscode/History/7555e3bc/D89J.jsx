...
export default async function Page({ params }) {
  ...
  const DocumentCard = ({ label, url, icon }) => {
    ...
    return (
      <div className="group relative rounded-xl border p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg">
  ...
  const InfoCard = ({ title, children, icon }) => (
    <div className="rounded-xl border p-6 shadow-sm transition-all duration-300 hover:border-gray-200 hover:shadow-md">
