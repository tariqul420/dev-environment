...
export const adminPaymentsColumns = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="w-32">
          <Badge variant="outline" className="px-1.5 py-1 font-mono">
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="w-28">
          <Badge className="px-1.5 py-1 font-mono" variant="secondary">
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="w-32">
        <Badge
          variant="outline"
          className={cn("px-1.5 py-1 capitalize border", statusColor(row.original?.status))}
        >
          {row.original?.status || "—"}
        </Badge>
      </div>
