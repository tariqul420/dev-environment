...
const components = {
  h1: (props: HeadingProps) => <h1 className="font-medium text-2xl pt-12 mb-0" {...props} />,
  h2: (props: HeadingProps) => <h2 className="text-gray-800 dark:text-zinc-200 font-medium mt-8 mb-3 text-xl" {...props} />,
  ...
  blockquote: (props: BlockquoteProps) => <blockquote className="ml-[0.075em] border-l-3 border-gray-300 pl-4 text-gray-700 dark:border-zinc-600 dark:text-zinc-300" {...props} />,
};
