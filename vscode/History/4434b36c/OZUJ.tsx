  ...
  return (
    <div className="space-y-4">
      <ToolPageHeader
        ...
        actions={<CopyButton getText={() => (typeof window !== 'undefined' ? window.location.href : '')} label="Copy page link" copiedLabel="Copied" variant="outline" size="sm" className="gap-2" />}
      />
