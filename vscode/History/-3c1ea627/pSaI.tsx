...
export default function PasswordGeneratorPage() {
  ...
  return (
    <MotionGlassCard className="container mx-auto max-w-4xl p-4 md:p-6 lg:p-8">
      <GlassCard className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
