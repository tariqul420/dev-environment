    ...
    <nav
      ...
      <div className="mx-auto flex w-[90vw] max-w-7xl items-center justify-between md:ps-5">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link href="https://github.com/your-username/your-repo" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition" aria-label="View on GitHub">
