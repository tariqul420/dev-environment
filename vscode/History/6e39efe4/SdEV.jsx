// app/admin/payments/[id]/page.jsx
...
// You already have actions for CRUD
...
export const dynamic = "force-dynamic"; // or use fetch/cache controls in your action
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription className="flex flex-wrap gap-2">
            ...
            <Badge variant="outline" className={`border px-1.5 py-1 ${statusTone(payment.status)}`}>
              {payment.status || "—"}
            </Badge>
          </CardDescription>
        </CardHeader>
