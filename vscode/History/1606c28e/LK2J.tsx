  ...
  return (
    <>
          ...
          <aside className="space-y-5 lg:sticky lg:top-24">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <QuantityInput id={product.id} disabled={!product.inStock} />
                <BuyNowBtn product={product} isOut={!product.inStock} />
                <AddToCartButton product={product} isOut={!product.inStock} />
              </div>
              {!product.inStock && (
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t bg-background/85 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 py-3 lg:hidden">
        <div className="mx-auto flex flex-col max-w-5xl items-center justify-between gap-3">
          <div className="flex items-end gap-3">
            <span className="text-3xl font-bold text-accent-main">
              {price} ৳
            </span>
