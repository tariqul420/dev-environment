...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  return (
    <Sidebar collapsible="icon" {...props}>
      {/* Header */}
      <SidebarHeader className="flex items-center gap-2 px-3 py-4 border-b">
      ...
      <div className="mt-auto border-t">
        <div className="flex flex-col p-3 gap-2 text-sm text-muted-foreground">
          <a href="/settings" className="rounded-md px-2 py-1 hover:bg-muted hover:text-foreground transition">
            Settings
          </a>
          <a href="/about" className="rounded-md px-2 py-1 hover:bg-muted hover:text-foreground transition">
            About
          </a>
          <a href="/help" className="rounded-md px-2 py-1 hover:bg-muted hover:text-foreground transition">
            Help
          </a>
        </div>
      </div>
