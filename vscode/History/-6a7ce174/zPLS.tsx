...
const DATA = {
  social: {
    Gmail: {
      name: "Send Email",
      url: "mailto:support@naturalsefa.com",
      icon: Icons.email,
    },
    Facebook: {
      name: "Facebook",
      url: "https://www.facebook.com/naturalsefabd",
      icon: Icons.facebook,
    },
    Youtube: {
      name: "Youtube",
      url: "https://www.youtube.com/channel/UCZDOWSPodbqYsi4WIlUwc1g",
      icon: Icons.youtube,
    },
    Whatsapp: {
      name: "Whatsapp",
      url: "https://chat.whatsapp.com/G62FiyRWJnN8zSvNhfmMhY",
      icon: Icons.whatsapp,
    },
    Phone: {
      name: "Phone",
      url: "tel:+8809647-001177",
      icon: Icons.phone,
    },
  },
};
