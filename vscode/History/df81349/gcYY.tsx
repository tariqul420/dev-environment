          ...
          return (
            <>
              <div className="relative min-w-0 flex-1">
                  ...
                  {labels.slice(0, 3).map((lab, i) => {
                    ...
                    return (
                      <Badge
                        key={val}
                        variant="secondary"
                        className="max-w-[140px] shrink-0 cursor-pointer truncate"
                ...
                {/* right fade */}
                <div className="pointer-events-none absolute top-0 right-6 h-full w-8 bg-gradient-to-l from-[hsl(var(--background))] to-transparent" />
              </div>
