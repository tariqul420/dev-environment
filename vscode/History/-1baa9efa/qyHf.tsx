  ...
  return (
    <MotionGlassCard className="p-4 md:p-6 lg:p-8">
      <ToolPageHeader
        ...
        actions={
          <>
            <ResetButton onClick={resetAll} beforeIcon={RotateCcw} />
            <ExportTextButton
              variant="outline"
              label="Export JSON"
              filename="hash-results.json"
              beforeIcon={DownloadCloud}
              getText={() =>
                JSON.stringify(
                  {
                    mode,
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <GlassCard className="shadow-sm">
          ...
          <CardFooter className="flex gap-2">
            <ActionButton label="Hash" onClick={() => void run()} beforeIcon={Hash} />
            <ActionButton
              label="Reset"
              variant="outline"
              onClick={resetAll}
                  ...
                  <div key={r.name} className="flex flex-col gap-2 rounded-md border p-3">
                    <div className="flex items-center justify-between">
                      ...
                      <CopyButton
                        ...
                        beforeIcon={copiedKey === r.name ? Check : undefined}
                        getText={() => r.value}
                        onCopied={() => {
                          setCopiedKey(r.name);
