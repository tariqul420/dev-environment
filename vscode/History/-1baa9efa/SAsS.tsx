...
// Ensure a Uint8Array backed by a real ArrayBuffer (not SharedArrayBuffer)
function toPlainU8(u8: Uint8Array): Uint8Array {
...
async function digest(algo: 'MD5' | 'SHA-1' | 'SHA-256' | 'SHA-384' | 'SHA-512', data: Uint8Array): Promise<Uint8Array> {
  ...
  // WebCrypto needs a BufferSource with an ArrayBuffer backing; normalize first
  const ab = await crypto.subtle.digest(algo, toPlainU8(data));
