...
import { PrintSaveBar, PrintStyles } from "@/components/shared/print-save";
    ...
    <>
      ...
      <GlassCard className="shadow-sm print:shadow-none print:bg-white print:border-0">
        ...
        <CardContent>
          <div
            ref={previewRef}
            className="bg-background/50 rounded-xl border p-6 print:bg-transparent print:border-0"
          >
