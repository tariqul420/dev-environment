...
function getHeaderContent(status: string) {
  const statusMessages = {
    PENDING: {
      title: "অর্ডারটি পেন্ডিং রয়েছে",
      message: "আপনার অর্ডারটি পেন্ডিং এ রয়েছে। খুব শিগগিরই নিশ্চিত করা হবে, ইনশা-আল্লাহ।"
    },
    HOLD: {
      title: "অর্ডারটি হোল্ডে রয়েছে",
      message: "আপনার অর্ডারটি সাময়িকভাবে হোল্ডে রয়েছে। আরও তথ্যের জন্য আমাদের সাথে যোগাযোগ করুন।"
    },
    CONFIRMED: {
      title: "অর্ডার নিশ্চিত করা হয়েছে",
      message: "আপনার অর্ডারটি সফলভাবে নিশ্চিত করা হয়েছে। খুব শিগগিরই প্রসেসিং এর জন্য পাঠানো হবে, ইনশা-আল্লাহ।"
    },
    PROCESSING: {
      title: "অর্ডার প্রসেসিং এ রয়েছে",
      message: "আপনার অর্ডারটি বর্তমানে প্রসেসিং এ রয়েছে। খুব শিগগিরই শিপমেন্টের জন্য প্রস্তুত হবে, ইনশা-আল্লাহ।"
    },
    SHIPPED: {
      title: "অর্ডার শিপ করা হয়েছে",
      message: "আপনার অর্ডারটি শিপ করা হয়েছে। খুব শিগগিরই আপনার কাছে পৌঁছে যাবে, ইনশা-আল্লাহ।"
    },
    DELIVERED: {
      title: "অর্ডার ডেলিভার হয়েছে",
      message: "আপনার অর্ডারটি সফলভাবে ডেলিভার করা হয়েছে। আমাদের সেবা নেওয়ার জন্য ধন্যবাদ।"
    },
    CANCELLED: {
      title: "অর্ডার বাতিল করা হয়েছে",
      message: "আপনার অর্ডারটি বাতিল করা হয়েছে। কোনো প্রশ্ন থাকলে আমাদের সাথে যোগাযোগ করুন।"
    }
  };

  return statusMessages[status as keyof typeof statusMessages] || statusMessages.PENDING;
}
