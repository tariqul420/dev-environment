...
NEXT_PUBLIC_SERVER_URL=https://tariqul.com
```
...
- **Certbot ইনস্টল** (যদি ইতিমধ্যে না করা থাকে):
...
- Certbot-এর প্রম্পটে ইমেইল ঠিকানা দিন এবং শর্তাবলীতে সম্মত হন।
- HTTP থেকে HTTPS-এ রিডাইরেক্টের জন্য "2" (Redirect) নির্বাচন করুন।
