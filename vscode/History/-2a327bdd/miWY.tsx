...
export default function LinkExpandClient() {
  ...
  /* Build CSV rows for history export (reusable ExportCSVButton) */
          ...
          {result && (
            <>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <TextareaField className="min-h-[80px]" readOnly={false} label="Description" value={meta?.ogDescription || meta?.description || ''} placeholder="—" />
