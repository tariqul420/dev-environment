...
export const metadata: Metadata = {
  ...
  title: 'Blogs | Tariqul Islam — Insights on Web Development & Design',
  description:
  ...
  alternates: { canonical: 'https://tariqul.dev/blogs' },
  openGraph: {
    title: 'Blogs | Tariqul Islam — Web Development & Design Insights',
