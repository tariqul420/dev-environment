export const metadata = {
  title: 'Deployment Guide for Next.js Application on VPS',
  ...
  openGraph: {
    ...
    url: 'https://yourdomain.com/blogs/next-js-deploy-in-vps',
...
# Deployment Guide for Next.js Application on VPS
