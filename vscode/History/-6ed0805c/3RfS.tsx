...
export type CopyButtonProps = {
  getText: GetText; // string or function returning string/Promise<string>
  label?: string;
  copiedLabel?: string;
  withToast?: boolean; // default: true
  toastText?: string; // default: "Copied!"
  timeoutMs?: number; // default: 1000
  variant?: Variant; // default: "outline"
  size?: Size; // default: "sm"
  className?: string;
  disabled?: boolean;
  leftIcon?: React.ReactNode; // override icon when idle
  leftIconCopied?: React.ReactNode; // override icon when copied
