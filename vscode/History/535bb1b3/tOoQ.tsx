...
export function ToolsSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar className="relative overflow-hidden border-muted/40 bg-background/40 backdrop-blur supports-[backdrop-filter]:bg-background/30" collapsible="icon" {...props}>
      {/* Header */}
