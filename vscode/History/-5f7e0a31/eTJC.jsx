...
export default function AddToCard({ courseId, course, user }) {
  ...
  return (
    <Button
      ...
      className={`${
        notStudent
          ? "dark:bg-dark-hover mt-5 inline-block w-full cursor-not-allowed rounded bg-gray-400 px-4 py-1.5 text-white transition-colors"
          : "bg-main hover:bg-main mt-5 inline-block w-full cursor-pointer rounded px-4 py-1.5 text-white transition-colors"
      }`}
    >
      Add to card
    </Button>
