...
// date-fns এর native format() timeZone নেয় না, তাই date-fns-tz ব্যবহার করলাম
...
export default function DashboardHeader() {
  ...
  const formattedTime = formatInTimeZone(currentTime, "Asia/Dhaka", "PPP · p");
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  <span
                    aria-hidden
                    className="outline-background absolute top-1 right-1 h-2.5 w-2.5 rounded-full bg-red-500 outline outline-2"
                  />
                </Button>
              </TooltipTrigger>
              <TooltipContent>
