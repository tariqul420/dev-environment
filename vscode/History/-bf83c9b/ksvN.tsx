    ...
    <footer className="py-12 px-4 font-english border-t">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="space-y-4">
          <Logo />
          <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed font-bangle">
            ন্যাচারাল শেফা — আপনার জন্য নিয়ে আসছে বিশ্বস্ত ভেষজ প্রতিকার এবং সুস্থতার সমাধান, যা
            বিশুদ্ধ উপাদান দিয়ে তৈরি, যা একটি স্বাস্থ্যকর, সুখী জীবনকে সমর্থন করে।
          </p>
