...
export default function NoResults({ title = 'No Results Found', description = "We couldn't find what you're looking for. Try adjusting your search or filters.", className }: NoResultsProps) {
  return (
