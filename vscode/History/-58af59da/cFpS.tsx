          ...
          <AreaChart data={filteredData}>
            <defs>
              ...
              <linearGradient id="fillOrder" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  style={{ stopColor: "var(--color-order)", stopOpacity: 0.9 }}
                />
                <stop
                  offset="95%"
                  style={{ stopColor: "var(--color-order)", stopOpacity: 0.12 }}
                />
              </linearGradient>
              ...
              <linearGradient id="fillSales" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  style={{ stopColor: "var(--color-sales)", stopOpacity: 0.8 }}
                />
                <stop
                  offset="95%"
                  style={{ stopColor: "var(--color-sales)", stopOpacity: 0.1 }}
                />
              </linearGradient>
