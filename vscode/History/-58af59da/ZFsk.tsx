...
/** Read a CSS variable from :root and update on theme (.dark) changes */
...
export function ChartAreaInteractive({
  ...
  // ✅ resolve CSS vars to actual color strings (rgb/hsl)
  ...
  // give colors to ChartContainer config (for legends/tooltips)
