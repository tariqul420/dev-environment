...
import { ClipboardListIcon, HandHelpingIcon, Mail } from "lucide-react";
...
export default function AdminOrderTableMenu({ row }: AdminOrderTableMenuProps) {
  ...
  const handleDelete = async () => {
    ...
    toast.promise(
      deleteOrder(row.original._id.toString(), pathname as string),
      {
  ...
  const handleCopy = () => {
    const { name, address, phone, product } = row.original;
