  ...
  return (
    <section id="about-me" className="pt-24">
      <div className="relative flex flex-col gap-12 lg:flex-row items-center">
        ...
        <div className="lg:w-[70%] flex flex-col items-center lg:items-start text-dark-lite dark:text-white">
          <AnimationContainer delay={0.2}>
            <BadgeTitle title="About Me" />
          </AnimationContainer>
          <TextAnimate animation="fadeIn" by="character" once delay={0} duration={0.5} className="text-center lg:text-start text-3xl text-primary1 font-semibold leading-[48px] mb-4">
            Md. Tariqul Islam
          </TextAnimate>
          <TextAnimate animation="blurInUp" by="character" once delay={0.5} duration={0.7} className="text-justify text-lg font-medium leading-[31px]">
