...
export default function MetaGeneratorPage() {
  ...
  function downloadPreviewTags() {
    downloadTxt("meta-tags.html", output || "");
  }
      ...
      <ToolPageHeader
        ...
        actions={
          <>
            ...
            <CopyButton disabled={!hasOutput} getText={copyPreviewTags()} />
            <ExportTextButton
              variant="default"
              disabled={!hasOutput}
              label="Download"
        ...
        <CardContent className="grid gap-6 md:grid-cols-2">
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button size="sm" className="gap-2" onClick={downloadPreviewTags}>
                <Download className="h-4 w-4" /> Download
              </Button>
              {s.canonical && isHttpUrl(s.canonical) && (
