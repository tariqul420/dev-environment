// app/tools/dev/csv-json/page.tsx
...
export const metadata = buildMetadata({
  title: "CSV ⇄ JSON Converter • Tools Hub",
  description:
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. By default the first row is treated as headers for CSV→JSON. You can switch to no-headers mode or customize which row contains headers.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. Choose comma, semicolon, or tab — or set a custom delimiter. You can also control quote and escape characters.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "The schema preview attempts to infer numbers, booleans, dates, and nulls. You can turn inference off to keep everything as strings.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "No. All conversions run locally in your browser. Nothing is stored or transmitted unless you export a file to your device.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text:
            "Yes. Enable flatten to convert nested objects/arrays into dot/bracket paths for CSV, and unflatten to reconstruct JSON from CSV later.",
        },
      },
    ],
  };
