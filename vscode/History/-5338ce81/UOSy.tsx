...
import AdminBlogTableMenu from "@/components/dashboard/admin/admin-blog-table-menu";
import AdminCategoryTableMenu from "@/components/dashboard/admin/admin-category-table-menu";
import AdminOrderTableMenu from "@/components/dashboard/admin/admin-order-table-menu";
import AdminProductTableMenu from "@/components/dashboard/admin/admin-product-table-menu";
import ReviewTableMenu from "@/components/dashboard/admin/review-table-menu";
import {
  createDragColumn,
...
import useStatusIcon from "@/hooks/use-status-icon";
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Badge
          variant="outline"
          className={`px-1.5 capitalize ${getStatusColor()}`}
        >
          {getStatusIcon()}
          {row.original.status}
        </Badge>
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <Badge
          variant="outline"
          className={`px-1.5 capitalize ${useStatusColor(row.original.status as string)}`}
        >
          {useStatusIcon(row.original.status as string)}
          {row.original.status}
        </Badge>
      );
    },
