        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="grid gap-4">
            <GlassCard className="p-4">
              ...
              <div className="mt-3 mx-auto flex items-center justify-center shadow-sm" style={{ width: total, height: total, padding: margin, borderRadius: rounded, ...gradientStyle }}>
                <div className="relative" ref={svgWrapperRef} style={{ width: size, height: size }}>
                  <QRCode
                    value={value || ' '}
                    size={size}
                    level={level}
                    // When we apply gradient inside modules, fgColor gets overridden; still fine
                    fgColor={useQrGradient ? '#000000' : fg}
