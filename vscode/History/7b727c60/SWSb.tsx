...
export default async function Home() {
  ...
  const personJsonLd = {
    ...
    sameAs: ['https://www.linkedin.com/in/your-id', 'https://github.com/your-id', 'https://x.com/your-id'],
  };

  // যদি তোমার সাইটে সার্চ পেজ না থাকে, target হিসেবে হোমপেজ query param ব্যবহার করো
  const websiteJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
    name: 'tariqul.dev',
