...
export default async function Home() {
  ...
  const personJsonLd = {
    ...
    sameAs: ['https://www.linkedin.com/in/tariqul-dev', 'https://github.com/tariqul_420', 'https://x.com/tariqul_420', 'https://facebook.com/tariquldev', 'https://dev.to/tariqul420'],
  };
