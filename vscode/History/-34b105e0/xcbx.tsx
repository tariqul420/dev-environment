...
const smartFill = React.useCallback(() => {
  // derive base from inputs
  let base = [...BASE_TEMPLATE]; // if these are imported constants, no dep needed for them
  ...
  // de-dupe by label+cat keeping highest qty/must (see #2 for safe Map merge)
...
}, [template, climate, nights]); // <-- only real inputs; imported constants/helpers don’t need deps
