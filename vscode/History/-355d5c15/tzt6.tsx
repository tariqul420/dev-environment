...
import { ArrowLeftRight, Check, Copy, Download, FileDown, FileUp, Image as ImageIcon, Link2, RefreshCw, RotateCcw, Settings2, ShieldCheck, Zap } from 'lucide-react';
...
function downloadBlob(filename: string, content: string | ArrayBuffer | Uint8Array | Blob, type = 'application/octet-stream') {
  let blob: Blob;
