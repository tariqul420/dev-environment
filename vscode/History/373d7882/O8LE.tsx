            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button
                  variant="outline"
                  className="gap-2"
                  onClick={() => navigator.clipboard.writeText(JSON.stringify({ utm, options: opts }, null, 2))}
                >
            ...
            <div className="space-y-3">
              <div className="flex flex-wrap gap-2">
                ...
                <Button
                  ...
                  onClick={() => navigator.clipboard.writeText(resultBatch.join('
'))}
                >
        ...
        <div key={i} className="p-3 grid gap-2 sm:grid-cols-[1fr_auto] sm:items-center">
          <div className="min-w-0">
            ...
            {Array.isArray(h.result) ? (
              <div className="mt-1 text-sm">Batch • {(h.result as string[]).length} links</div>
            ) : (
