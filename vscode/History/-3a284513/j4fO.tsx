...
import { Calculator, Calendar as CalendarIcon, Download, History, RotateCcw } from "lucide-react";
    ...
    <>
        ...
        actions={
          <>
            ...
            <ActionButton
              ...
              label="Calculate"
              onClick={() => {
                /* values are reactive; button provided for UX parity */
              }}
            />
          </>
        }
      ...
      <GlassCard className="shadow-sm">
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <SelectField value={currency} onValueChange={(v) => setCurrency(v as Currency)} />
      ...
      <GlassCard className="shadow-sm">
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-xl border p-4">
            ...
            <div className="mt-2">
              <CopyButton size="sm" label="Copy" getText={() => fmt(baseEmi, currency)} />
            </div>
          </div>
