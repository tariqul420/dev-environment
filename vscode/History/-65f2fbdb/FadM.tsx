...
export default function ProductCard({
  ...
  const computedMax = useMemo(() => {
    ...
    const stockCap = product.inStock ? product.stock : 0;
  ...
  return (
    ...
    >
      ...
      <CardContent className="flex flex-grow flex-col justify-between pt-0">
        ...
        >
          ...
          <Button
            ...
            disabled={isOut || qty >= (computedMax || 1)}
      ...
      >
        <BuyNowBtn isCard product={product} className="flex-1" isOut={isOut} />
        <AddToCartButton isCard product={product} isOut={isOut} />
      </CardFooter>
    </Card>
  );
}
