...
export default function ProductCard({
  ...
  return (
    ...
    >
      <CardHeader className="relative rounded-md p-0 aspect-square">
        ...
        {discountPercent && (
          <span className="absolute top-2 right-2 z-[2] rounded-full bg-accent px-2.5 py-0.5 text-[10px] font-semibold text-accent-foreground shadow sm:px-3 sm:py-1 sm:text-xs w-fit">
            -{discountPercent}%
          </span>
        )}
