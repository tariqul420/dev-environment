...
import { ArrowRight, Calendar, Code2, Globe, Sparkles, Target, Users, Zap } from 'lucide-react';
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-start">
        ...
        <AnimationContainer delay={0.2}>
          <div className="relative group">
            <ImageGallery images={project.screenshots ?? [project.coverImage]} name={project.title} />
          </div>
        </AnimationContainer>
            ...
            <Card className="p-4">
              <div className="space-y-4">
                <div className="flex items-center gap-2 text-primary">
                  ...
                  <h3 className="font-semibold">Team & Duration</h3>
                </div>
                <div className="space-y-2">
                  {/* DevelopmentTime, TeamSize are not in interface, add if needed */}
                  {/* You can remove or adjust these lines if those fields do not exist */}
                  {/* <p className="flex items-center gap-2">
                    <span className="font-medium">Development Time:</span>
                    <span className="text-muted-foreground">{project.developmentTime || 'N/A'}</span>
                  </p>
                  <p className="flex items-center gap-2">
                    <span className="font-medium">Team Size:</span>
                    <span className="text-muted-foreground">{project.teamSize || 'N/A'}</span>
                  </p> */}
                </div>
              </div>
            </Card>
            <Card className="p-4">
              <div className="space-y-4">
                <div className="flex items-center gap-2 text-primary">
                  ...
                  <h3 className="font-semibold">Platforms & Tags</h3>
                </div>
                <div className="space-y-2">
                  <p className="flex items-center gap-2">
                    <span className="font-medium">Platforms:</span>
                    <span className="text-muted-foreground">{project.tags?.join(', ') || 'N/A'}</span>
                  </p>
                  <p className="flex items-center gap-2">
