...
import { Code, Copy, Filter, Info, ListChecks, Regex, Save, Scissors, Timer } from "lucide-react";
...
for (const m of matches) {
  ...
  function highlightText(text: string) {
    // Example regex: wrap words starting with capital letter
    const regex = /\b(Hello|World|Email|foo|example|com)\b/g;
            ...
            <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as typeof activeTab)}>
              ...
              <TabsContent value="match" className="space-y-3">
                <div className="rounded-md border p-3">
                  <div className="prose prose-sm max-w-none whitespace-pre-wrap font-mono leading-relaxed dark:prose-invert">
