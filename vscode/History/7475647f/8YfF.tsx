...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: '/assets/images/tariqul-islam.jpeg' }, { url: '/assets/logo/logo.png' }],
  },
  twitter: { card: 'summary_large_image', title: 'Tariqul Islam — Web Developer & Designer | Portfolio' },
};
