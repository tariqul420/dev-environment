...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Explore the portfolio of Tariqul Islam, a skilled web developer with expertise in Next.js, React, MongoDB, and full-stack engineering.',
  ...
  twitter: {
    ...
    title: 'Tariqul Islam — Web Developer & Designer | Portfolio',
    description: 'Explore the portfolio of Tariqul Islam, a web developer with expertise in Next.js, React, MongoDB, and modern technologies.',
