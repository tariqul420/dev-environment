...
export const metadata: Metadata = {
  ...
  description: 'Portfolio of Tariqul Islam — Web Developer & Designer. Showcasing projects, case studies, and skills in Next.js, React, MongoDB, and modern full-stack development from Bangladesh.',
  keywords: [
    'Tariqul Islam',
