...
export const metadata: Metadata = {
  ...
  description:
    'Portfolio of Tariqul Islam — Web Developer & Designer. Showcasing projects, case studies, and skills in Next.js, React, MongoDB, Postgres, Prisma, Typescript and modern full-stack development from Bangladesh.',
  keywords: [
    'Tariqul Islam',
  ...
  openGraph: {
    title: 'Tariqul Islam — Web Developer & Designer | Portfolio',
    description: 'Explore the portfolio of Tariqul Islam, a skilled web developer with expertise in Next.js, React, MongoDB, Postgres, Prisma, Typescript and full-stack engineering.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Tariqul Islam — Web Developer & Designer',
      },
      {
  ...
  twitter: {
    ...
    title: 'Tariqul Islam — Web Developer & Designer | Portfolio',
    description: 'Explore the portfolio of Tariqul Islam, a web developer with expertise in Next.js, React, MongoDB, Postgres, Prisma, Typescript and modern technologies.',
