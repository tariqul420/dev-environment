          ...
          {images.map((img, idx) => (
            <SwiperSlide key={idx as number}>
              <div className="relative">
                ...
                />
                {outOfStock && (
                  <span className="absolute inset-0 z-[2] flex items-center justify-center bg-black/80 px-4 py-2 rounded-md text-white text-sm font-semibold uppercase tracking-wide">
                    Out of stock
                  </span>
                )}
              </div>
