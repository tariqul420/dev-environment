...
export default function ProductDetailsImage({
  ...
  if (!images || images.length === 0) {
    return (
      <div className="flex aspect-square w-full max-w-full items-center justify-center overflow-hidden rounded-lg border">
  ...
  return (
    <div className="product-gallery w-full max-w-full overflow-hidden">
      <div className="relative w-full max-w-full overflow-hidden rounded-lg border">
        ...
        <div className="w-full max-w-full overflow-hidden">
          <Swiper
            ...
            className="main-swiper w-full max-w-full"
            style={
              {
              ...
              <SwiperSlide key={idx} className="!w-full">
                <div className="relative w-full">
                  <img
                    ...
                    className="aspect-square w-full max-w-full object-cover sm:rounded-lg transition-transform duration-300 ease-out md:hover:scale-[1.02]"
                    draggable={false}
                  />
                  {outOfStock && (
      ...
      <Swiper
        ...
        watchSlidesProgress
        modules={[FreeMode, Navigation, Thumbs]}
        className="thumbs-swiper mt-3 w-full max-w-full"
        breakpoints={{
        ...
        {images.map((img, index) => (
          ...
          >
            <img
              ...
              className="block h-full w-full max-w-full cursor-pointer object-cover"
              draggable={false}
            />
          </SwiperSlide>
        ))}
      ...
      <style jsx global>{`
        ...
        .product-gallery .swiper-slide > div,
        ...
        /* Keep buttons inside rounded edges */
        .product-gallery .swiper-button-prev,
        .product-gallery .swiper-button-next {
          top: 50%;
