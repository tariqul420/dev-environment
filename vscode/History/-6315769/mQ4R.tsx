        ...
        <CardContent className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="rounded-lg border p-3 space-y-3">
            <Tabs value={mode} onValueChange={(v) => setMode(v as Mode)} className="w-full">
              ...
              <TabsContent value="uuid" className="space-y-3">
              ...
              <TabsContent value="nanoid" className="space-y-3">
                <div className="grid gap-3 sm:grid-cols-2">
                  <InputField
                    label="Size"
                    type="number"
          ...
          <div className="rounded-lg border p-3 space-y-3">
            ...
            <div className="grid gap-2">
              ...
              <CopyButton getText={() => deEscapeDelimiter(delimiter || "\n")} />
            ...
            {list.length === 0 ? (
              ...
              <>
                ...
                <div className="md:hidden">
                  <CopyButton
                    label="Copy All"
                    getText={() => deEscapeDelimiter(delimiter || "\n")}
                  />
                  <TextareaField
                    readOnly
                    value={list.join("\n")}
