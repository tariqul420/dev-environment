...
export default function BgRemovePage() {
  ...
  React.useEffect(() => {
    const ov = overlayRef.current;
    if (!ov) return; // early exit; ov is HTMLCanvasElement after this line
    ...
    // listeners on the *narrowed* element
    ov.addEventListener('mousedown', start);
    ov.addEventListener('mousemove', move);
    window.addEventListener('mouseup', end);

    ov.addEventListener('touchstart', start, { passive: true });
