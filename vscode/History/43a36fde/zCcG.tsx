...
export default function DataTableFooter<TData extends BaseRecord>({
  ...
  return (
    <div className="flex flex-col justify-between gap-4 px-4 py-2 lg:flex-row lg:items-center">
      ...
      <div className="flex w-full flex-row gap-3 lg:w-fit lg:flex-col lg:flex-row lg:items-center lg:gap-8">
