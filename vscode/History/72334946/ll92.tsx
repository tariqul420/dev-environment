...
type LinkButtonProps = {
  href?: string; // optional so we can render disabled without a link
  ...
  external?: boolean; // alias to force new tab + rel
  target?: React.HTMLAttributeAnchorTarget;
  rel?: string;
  download?: boolean | string; // pass through to <a>
  ...
  return (
    ...
    >
      <Link
        ...
        // Next 13 forwards unknown props to <a>; TS may complain, so ignore if needed.
        // @ts-expect-error next/link forwards to <a>
