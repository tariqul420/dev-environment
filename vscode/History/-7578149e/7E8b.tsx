...
import { ActionButton, CopyButton, ExportTextButton, ImportFileButton, PasteButton, ResetButton } from '@/components/shared/action-buttons';
      ...
      <GlassCard className="shadow-sm">
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <TextareaField value={raw} onChange={(e) => setRaw(e.target.value)} placeholder="Paste here (Ctrl/Cmd + V)…" textareaClassName="min-h-[220px]" />
