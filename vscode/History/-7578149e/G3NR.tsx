...
import { ActionButton, CopyButton, PasteButton, ResetButton } from '@/components/shared/action-buttons';
...
import { Check, ClipboardCopy, ClipboardType, Download, Eraser, Upload, Wand2 } from 'lucide-react';
        ...
        <CardContent className="grid gap-4 lg:grid-cols-3">
          <div className="space-y-6">
            ...
            <div className="space-y-2 lg:col-span-3">
              <Label className="mb-2">Behavior</Label>
