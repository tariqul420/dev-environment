...
import { Eraser, Filter, Hash, List, ListOrdered, Replace, Scissors, Search, Shuffle, SortAsc, SortDesc } from 'lucide-react';
...
export default function LineToolsClient() {
  ...
  // always apply affixes/numbering to whichever is available: resultLines (after an op) or raw lines
  const output = useMemo(() => {
    ...
    // include both resultLines and lines in deps so it reacts live to input/trim/removeEmpty AND ops
