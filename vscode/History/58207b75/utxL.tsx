...
export default function Footer() {
  return (
    <footer className="bg-dark-lite font-grotesk w-full">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 pt-12 pb-6 sm:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col">
            <Logo
              className="text-light"
              className1="text-accent-hover"
              className2="text-light"
            />
            ...
            <div className="mt-4 flex space-x-4">
              <Link
                ...
                className="text-red focus:ring-accent-main underline transition-all duration-300 hover:-translate-y-1 hover:text-white focus:ring-2 focus:ring-offset-2"
