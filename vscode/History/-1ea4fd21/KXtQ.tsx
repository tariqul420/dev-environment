          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <GlassCard className="p-5">
              ...
              <label
                ref={dropRef}
                htmlFor="file-input"
                className="flex cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border border-dashed p-8 text-center transition hover:bg-muted/50 min-h-[180]"
              >
