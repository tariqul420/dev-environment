...
export default async function Product({
  ...
  const [productsResponse, product] = results as [
    GetProductsResponse,
    IProduct,
  ];

  const review = await getReviews(product.slug);
  ...
  return (
    <div className="py-12">
          ...
          <TabsContent value="shipping" className="mt-6 space-y-6">
            ...
            <div>
              ...
              <ul className="mt-2 list-inside list-disc space-y-1">
                ...
                <li>কার্যকাল: সকাল ৯:০০ - রাত ৮:০০ (বাংলাদেশ সময়)</li>
              </ul>
            </div>
          </TabsContent>
        </Tabs>
      ...
      <section>
        ...
        <CarouselContainer<ReviewProps> items={productsResponse.products}>
          {(item: ReviewProps) => <ReviewCard review={} />}
        </CarouselContainer>
      </section>
