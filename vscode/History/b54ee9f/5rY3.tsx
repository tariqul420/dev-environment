        ...
        <section>
          <Tabs defaultValue="description" className="w-full">
            ...
            <TabsContent value="description" className="mt-6 space-y-6">
              <div>
                <h2 className="mb-2 text-2xl font-semibold">পণ্যের নাম</h2>
                <p>
              ...
              <div>
                <h2 className="mb-2 text-2xl font-semibold">বিবরণ</h2>
                <p>{product.shortDesc}</p>
              </div>

              <div>
                <h2 className="mb-2 text-2xl font-semibold">বিস্তারিত তথ্য</h2>
            ...
            <TabsContent value="shipping" className="mt-6 space-y-6">
              <div>
                <h2 className="mb-2 text-2xl font-semibold">ডেলিভারি তথ্য</h2>
                <p>
              ...
              <div>
                <h2 className="mb-2 text-2xl font-semibold">পরিবহন নীতি</h2>
                <p>
                  আমরা বাংলাদেশের সারা দেশে বিনামূল্যে ডেলিভারি সুবিধা প্রদান
                  করি। এই অফারটি আমাদের গ্রাহকদের জন্য একটি বিশেষ উপহার!
                </p>
              </div>

              <div>
                <h2 className="mb-2 text-2xl font-semibold">রিটার্ন নীতি</h2>
                <p>
                  ডেলিভারির ৭ দিনের মধ্যে পণ্যটি খোলা না থাকলে এবং এর আসল
                  প্যাকেজিংয়ে থাকলে আমরা রিটার্ন গ্রহণ করি। রিটার্নের জন্য
                  আমাদের কাস্টমার সার্ভিসে যোগাযোগ করুন।
                </p>
              </div>

              <div>
                <h2 className="mb-2 text-2xl font-semibold">যোগাযোগের তথ্য</h2>
                <p>
