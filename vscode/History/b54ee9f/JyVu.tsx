        ...
        <section>
          <Tabs defaultValue="description" className="w-full">
            ...
            <TabsContent value="description" className="mt-6 space-y-6">
              <div>
                <h2 className="mb-2 text-2xl font-bold">পণ্যের নাম</h2>
                <p>
              ...
              <div>
                <h2 className="mb-2 text-2xl font-bold">বিবরণ</h2>
                <p>{product.shortDesc}</p>
              </div>

              <div>
                <h2 className="mb-2 text-2xl font-bold">বিস্তারিত তথ্য</h2>
            ...
            <TabsContent value="shipping" className="mt-6 space-y-6">
              <div>
                <h2 className="mb-2 text-2xl font-bold">ডেলিভারি তথ্য</h2>
                <p>
              ...
              <div>
                <h2 className="mb-2 text-2xl font-bold">পরিবহন নীতি</h2>
                <p>
              ...
              <div>
                <h2 className="mb-2 text-2xl font-bold">রিটার্ন নীতি</h2>
                <p>
              ...
              <div>
                <h2 className="mb-2 text-2xl font-bold">যোগাযোগের তথ্য</h2>
                <p>
