...
export default function ToolsHeader() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-40 flex h-[--header-height] shrink-0 items-center border-b supports-[backdrop-filter]:bg-background/60 backdrop-blur-lg bg-gradient-to-b from-background/70 to-background/30 transition-[width,height,backdrop-filter] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-[--header-height] py-2">
