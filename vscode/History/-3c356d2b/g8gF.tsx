...
/* Shared UI — your reusable components */
  ...
  return (
    <TooltipProvider>
      ...
      <ToolPageHeader
        ...
        description="Prettify, minify, validate, sort keys, query by path, infer TypeScript, and run quick text conversions."
        actions={
          <>
            {/* Import file */}
            <InputField
      ...
      {/* Options */}
      <GlassCard className="shadow-sm mb-4">
        <CardHeader>
        ...
        <CardContent className="grid gap-3 md:grid-cols-4">
          ...
          <SwitchRow
            label="Sort keys"
            hint="Sort object keys alphabetically (deep). Arrays unchanged."
            checked={sortKeys}
          ...
          <div className="hidden md:flex items-center gap-2">
            <Badge>Lines: {stats.lines}</Badge>
            <Badge>Chars: {stats.chars}</Badge>
          </div>
        </CardContent>
      </GlassCard>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <ActionButton
                  ...
                  variant="ghost"
                />
                <CopyButton variant="ghost" getText={() => output || ""} disabled={!output} />
              </div>
            </div>
