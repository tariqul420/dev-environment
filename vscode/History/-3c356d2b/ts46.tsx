            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <PasteButton
                  ...
                  getExisting={() => input}
                  setValue={(next) => {
                    // If auto-formatting is enabled, try to pretty-print JSON first
                    if (autoOnPaste) {
                      try {
                  ...
                  onText={(raw) => {
                    // Optional: if you ever change to append modes, this keeps behavior consistent
