      ...
      <div className="relative container mx-auto flex h-full flex-col items-center justify-between overflow-hidden py-5 md:gap-5 lg:max-w-6xl lg:flex-row">
        ...
        <div className="z-[5] w-full text-center lg:w-1/2 lg:text-left">
          ...
          <div className="mt-5 mb-5 flex flex-col items-center justify-center gap-4 sm:flex-row lg:justify-start">
            <Link
              href="/products"
              className="group border-accent-main bg-accent-main hover:border-accent-hover hover:bg-accent-hover text-light relative flex cursor-pointer items-center gap-2 rounded border px-4 py-2.5 duration-200 md:px-6"
            >
              <Image
                src="/assets/star-blaze.gif"
                alt="Star Blaze"
            ...
            <Link
              href="/contact-us"
              className="hover:bg-light-bg bg-light dark:bg-dark-lite flex cursor-pointer items-center gap-2 rounded border px-4 py-2.5 shadow duration-200 md:px-6"
            >
        ...
        <div className="mt-5 grid w-full grid-cols-2 gap-5 px-3 sm:px-0 md:w-[600px]">
          ...
          <div className="relative col-span-2 h-[200px] md:h-[250px]">
            <Image
              src="https://scontent.fdac90-1.fna.fbcdn.net/v/t39.30808-6/502565866_648192168264506_6742247463109512812_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=127cfc&_nc_ohc=R7L0pZ0G_R8Q7kNvwHtBHdO&_nc_oc=Adni049zLyZNYXiUpYaFugrtpi8A6Qc0OTvUgQQjaRwe2IdXvEROK4aMCxRexKUTC8s&_nc_zt=23&_nc_ht=scontent.fdac90-1.fna&_nc_gid=DZwwJHLJ90Rn-uIE0OOz0Q&oh=00_AfSVgNl_EmvQxFYOh3QyxADI1h4TC--rYAvSwfEBfaNUvw&oe=687A94C2"
              alt="Hero Image"
              fill
