...
function HeroSection() {
  return (
    <section className="relative min-h-[550px]">
      <div className="relative container mx-auto flex h-full flex-col items-center justify-between py-5 md:gap-5 lg:max-w-6xl lg:flex-row">
        {/* Text Content */}
        <div className="z-[5] w-full text-center lg:w-1/2 lg:text-left">
          ...
          <h2 className="py-2 text-5xl leading-13 font-bold md:py-5 md:leading-16 lg:text-5xl">
            প্রাকৃতিকভাবে{" "}
            <span className="from-accent-main to-accent-hover relative -top-1 bg-gradient-to-r bg-clip-text text-transparent md:top-0">
              সুস্থ থাকুন{" "}
            </span>
            Natural Sefa-র সাথে!
          </h2>
        ...
        <div className="mt-5 grid w-full grid-cols-2 gap-5 px-3 sm:px-0 md:w-[600px]">
          {/* Full-width Image (LCP) */}
          <div className="relative col-span-2 h-[200px] md:h-[250px]">
            <Image
              src="/assets/hero-banner-1.png"
              alt="Natural Sefa hero banner showcasing organic skincare products"
              fill
              fetchPriority="high"
          ...
          <div className="relative col-span-1 h-[150px] md:h-[200px]">
            <Image
              ...
              alt="Natural Sefa skincare product close-up"
              fill
              loading="lazy"
              className="rounded-lg object-cover"
          ...
          <div className="relative col-span-1 h-[150px] md:h-[200px]">
            <Image
              ...
              alt="Natural Sefa product packaging display"
              fill
              loading="lazy"
              className="rounded-lg object-cover"
              sizes="(max-width: 768px) 50vw, (max-width: 1024px) 40vw, 300px"
