...
export const metadata: Metadata = {
  metadataBase: new URL('https://tariqul.dev/projects'),
  title: 'Projects | Tariqul Islam — Full-Stack Web Developer & Designer',
  description:
    'Explore the portfolio projects of Tariqul Islam — Full-Stack Developer & Designer from Bangladesh. Browse modern web applications, case studies, and open-source projects built with Next.js, React, TypeScript, Prisma, MongoDB, and PostgreSQL.',
  keywords: [
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/assets/og/projects.png', // 👉 create a nice OG banner
        width: 1200,
        height: 630,
