  ...
  return (
    <section className="py-12">
      ...
      {projects.length > 0 ? (
        ...
        <NoResults className="col-span-full" title="No Projects Found" description="We couldn't find what you're looking for. Try adjusting your filters or search terms." />
      )}
