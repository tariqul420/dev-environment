...
<CalcButton onClick={clear} variantIntent="danger" className="col-span-2"><Repeat className="mr-2 h-4 w-4"/>AC</CalcButton>
<CalcButton onClick={back}><Delete className="mr-2 h-4 w-4"/>DEL</CalcButton>
<CalcButton onClick={() => push('/')} variantIntent="accent"><Divide className="h-4 w-4"/></CalcButton>
...
<p className="text-xs text-muted-foreground">Tip: Use keyboard — Enter to evaluate, Backspace to delete, C to clear.</p>
</MotionGlassCard>
</div>
)
}