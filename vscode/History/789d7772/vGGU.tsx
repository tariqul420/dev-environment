...
import { updateUserRoleAction } from "@/app/actions/admin/update-user-role"; // <-- server action
  ...
  const handleSaveRole = async () => {
    startTransition(async () => {
      try {
        ...
        await toast.promise(
          updateUserRoleAction({ userId: user.id, role: selectedRole }),
          {
            loading: `Changing role to ${selectedRole}...`,
        ...
        router.refresh(); // optional (revalidatePath also ran on server)
      } catch (error) {
