      ...
      <ToolPageHeader
        ...
        actions={
          <>
            ...
            <ActionButton icon={Download} label="Markdown" onClick={exportMarkdown} />
          </>
        }
      />
      ...
      <GlassCard className="shadow-sm print:shadow-none">
        ...
        <CardContent>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Button className="gap-2" onClick={copyMarkdown}>
              <Copy className="h-4 w-4" /> {copied ? "Copied" : "Copy Header"}
            </Button>
            <Button className="gap-2" onClick={exportMarkdown}>
