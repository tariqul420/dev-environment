...
const TextToListClient = dynamic(() => import('@/components/tools/text/text-to-list-client'), { ssr: false });

export const metadata = buildMetadata({
  title: 'Text to List • Tools Hub',
  description: 'Split text by comma, newline, semicolon, or tab into a clean list. Trim, dedupe, sort, change case, and add prefix/suffix or numbering. Free online text to list converter.',
  path: '/tools/text/to-list',
  keywords: ['text to list', 'split text', 'comma separated list', 'newline separated list', 'dedupe list', 'sort list', 'add prefix suffix', 'number list', 'Tools Hub'],
});
