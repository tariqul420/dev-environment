...
import ResumeDownload from '../../lib/actions/send-email';
import LottieAnimation from '../LotteFile/LotteFile';
...
export function HeroSection() {
  return (
    <section id="home" className="min-h-screen flex flex-col lg:flex-row items-center justify-center gap-10 py-10">
      ...
      {/* Lottie Animation */}
      <div className="w-full lg:w-auto max-w-xs sm:max-w-sm md:max-w-md">
        <LottieAnimation />
      </div>
    </section>
  );
