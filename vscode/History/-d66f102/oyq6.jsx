...
export default function DataTableFooter({ table, pageSize, total }) {
    ...
    <div className="flex flex-col gap-4 px-4 py-3 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="flex flex-col items-start gap-3 sm:w-full sm:flex-row sm:items-center sm:justify-between lg:w-auto">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="icon" className="hidden h-8 w-8 p-0 lg:inline-flex" onClick={() => handlePageChange(1)} disabled={currentPage <= 1}>
          ...
          <Button variant="outline" size="icon" className="hidden h-8 w-8 lg:inline-flex" onClick={() => handlePageChange(totalPages)} disabled={currentPage >= totalPages}>
