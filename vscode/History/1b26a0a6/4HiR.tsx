...
export default function JwtDecodeClient() {
  ...
  // Verify
  const [secret, setSecret] = useState<string>(""); // HS256
  const [showSecret, setShowSecret] = useState<boolean>(false);
  const [publicKeyPem, setPublicKeyPem] = useState<string>(""); // RS256 PEM
  ...
  // Load token from URL param once (?token=...)
  useEffect(() => {
              ...
              <div className="mb-2 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <ActionButton
                    ...
                    beforeIcon={copied === "token" ? Check : ClipboardCopy}
                  />
                  <ActionButton
                    variant="ghost"
                    size="sm"
                  ...
                  <GlassCard className="p-4">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      <ActionButton
                        ...
                        beforeIcon={copied === "header" ? Check : ClipboardCopy}
                      />
                      <ActionButton
                        variant="outline"
                        ...
                        beforeIcon={copied === "payload" ? Check : ClipboardCopy}
                      />
                      <ExportTextButton
                        variant="outline"
                ...
                <div className="grid gap-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <ActionButton
                      ...
                      beforeIcon={showSecret ? EyeOff : Eye}
                    />
                  </div>
                </div>
              </GlassCard>
