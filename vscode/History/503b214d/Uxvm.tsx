...
export function OrderReceiptButton({ order }: { order: OrderReceiptData }) {
      ...
      .then((m) => {
        ...
        try {
          m.Font.register({
            ...
            fonts: [
              {
                src: "/fonts/noto-sans-bengali/regular.ttf",
                fontWeight: "normal",
              },
              {
  ...
  const renderDoc = () => {
    ...
    const dateStr = format(new Date(order.createdAt), "Pp", {
      locale: enUS,
    });
        ...
        <Page size="A4" style={styles.page}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>{order.paymentMethod || "COD"}</Text>
            </View>
          </View>
