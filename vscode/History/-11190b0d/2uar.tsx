  ...
  return (
    ...
    >
      ...
      <svg
        ...
        height="24"
        fill="currentColor"
        className="h-6 w-6 text-[--color-accent-main] dark:text-[--color-accent-hover]"
        viewBox="0 0 16 16"
      >
      ...
      {/* Brand Name */}
      <span className="font-[var(--font-serif)] text-[--color-accent-main] italic dark:text-[--color-accent-hover]">
        Natural
      </span>
      <span className="font-[var(--font-sans)] font-bold text-[--color-dark-deep] dark:text-[--color-light]">
        Sefa
      </span>
    </Link>
  );
