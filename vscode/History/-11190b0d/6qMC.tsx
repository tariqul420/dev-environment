...
export const Logo = ({ className, className1, className2 }: LogoProps) => {
  return (
    <Link
      href="/"
      className={cn(
    ...
    >
      ...
      <svg
        ...
        height="24"
        fill="currentColor"
        className="text-accent-main dark:text-accent-hover h-6 w-6"
        viewBox="0 0 16 16"
      >
      ...
      {/* Brand Name */}
      <span className="text-accent-main dark:text-accent-hover font-serif italic">
        Natural
      </span>
      <span className="text-dark-deep dark:text-light font-sans font-bold">
        Sefa
      </span>
    </Link>
  );
