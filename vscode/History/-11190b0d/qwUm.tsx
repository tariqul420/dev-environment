...
export const Logo = ({ className }: LogoProps) => {
  return (
    ...
    >
      ...
      {/* Brand Name */}
      <span className="font-serif text-[--color-accent-main] italic dark:text-[--color-accent-hover]">
        Natural
      </span>
      <span className="font-sans font-bold text-[--color-dark-deep] dark:text-[--color-light]">
        Sefa
      </span>
    </Link>
  );
