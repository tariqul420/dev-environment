...
export default function TimestampConverterClient() {
  ...
  }, [autoTick, dir, unit, tz, customTz, dateText, run]);
            ...
            {dir === "toDate" ? (
              ...
              <div className="flex items-end gap-4">
                <InputField
                  ...
                  value={dateText}
                  onChange={(e) => setDateText(e.target.value)} // ✅ expects ChangeEvent
                  className="w-full"
                />
                <div className="flex items-center gap-1">
                  <ActionButton
                    label="Now"
                    onClick={() => setDateText(new Date().toISOString())} // ✅ ISO 8601 for this field
                    icon={Clock3}
                    variant="default"
                  />
