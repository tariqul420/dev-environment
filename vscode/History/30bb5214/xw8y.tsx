        ...
        <CardContent className="space-y-4">
          ...
          {opts.batchMode && (
            <div className="space-y-3">
              <div className="flex flex-wrap gap-2">
                <Button className="gap-2" disabled={!resultBatch.length} onClick={exportBatchCSV}>
                    ...
                    {resultBatch.map((r, i) => (
                      ...
                      >
                        ...
                        <div className="flex gap-2 justify-end">
                          ...
                          <Button size="sm" onClick={() => window.open(r, "_blank", "noopener")}>
                            <Share2 className="h-4 w-4" /> Open
                          </Button>
                        </div>
                      </div>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-3 sm:grid-cols-[260px_1fr] sm:items-start">
            <div className="space-y-2">
              ...
              {!!selectedPreset && (
                <div className="flex gap-2">
                  <Button size="sm" className="gap-2" onClick={() => deletePreset(selectedPreset)}>
    ...
    <div className={cn("divide-y", items.length ? "" : "p-3 text-sm text-muted-foreground")}>
      ...
      {!!items.length && (
        <div className="p-3 flex justify-end">
          <Button size="sm" className="gap-2" onClick={clearAll}>
