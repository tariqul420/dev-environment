...
function Footer() {
  ...
  const socialIcons = [
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/tariqul-dev",
      svg: (
        <svg
          className="size-6 transition-transform duration-200 hover:scale-110"
          xmlns="http://www.w3.org/2000/svg"
    ...
    {
      name: "Facebook",
      href: "https://facebook.com/tariqul2984",
      svg: (
        <svg
          className="size-6 transition-transform duration-200 hover:scale-110"
          xmlns="http://www.w3.org/2000/svg"
    ...
    <footer className="py-6 px-4 sm:px-6 lg:px-8 font-inter relative overflow-hidden ">
      <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10">
        <div className="mb-6 flex items-center justify-center gap-4">
          <Image src="/assets/logo-transplant.png" height={24} width={24} alt="Tools Hub Logo" />
