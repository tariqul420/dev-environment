...
const contacts = [
  ...
  },
  {
    ...
    title: "LinkedIn",
    value: "linkedin.com/in/md-mosiur-rahman73",
    ...
    <section id="contact" className="relative mx-auto max-w-7xl px-4 py-20">
      <div className="text-center mb-14">
        ...
        <p className="mt-4 text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
          Ready to bring your ideas to life? Tell me a bit about your project and I&apos;ll get back soon.
        </p>
      </div>

      <div className="grid grid-cols-1 justify-center items-center gap-10 lg:grid-cols-2">
        {/* Left: Cards + Social */}
        <div className="space-y-8">
          ...
          <div className="rounded-2xl border bg-white/5 backdrop-blur p-6">
            ...
            <div className="flex flex-wrap gap-3">
              {socials.map((s, i) => (
                <SocialLinkButton key={i} href={s.href} icon={s.icon} label={s.label} />
              ))}
            </div>
          </div>
        </div>
